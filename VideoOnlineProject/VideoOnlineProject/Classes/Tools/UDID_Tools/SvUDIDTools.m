...
// replace the identity with your company's domain  //$(SRCROOT)/VideoOnlineProject/KeychainAccessGroups.plist
static const char kKeychainUDIDItemIdentifier[]  = "UUID";
static const char kKeyChainUDIDAccessGroup[] = "com.eric.VideoOnlineProject";
